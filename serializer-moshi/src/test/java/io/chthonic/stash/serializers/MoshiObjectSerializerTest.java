...
public class MoshiObjectSerializerTest {
    ...
    public void testSimpleObject() throws Exception {
        ...
        ObjectSerializer<Event> serializer = new MoshiObjectSerializer<Event>(Event.class);
    ...
    public void testObjectWithCollections() throws Exception {
        ...
        ObjectSerializer<CollecObj> serializer = new MoshiObjectSerializer<CollecObj>(CollecObj.class);
    ...
    public void testListOfObject() throws Exception {
        ...
        ObjectSerializer<List<Event>> serializer = new MoshiObjectSerializer<List<Event>>(Types.newParameterizedType(List.class, Event.class));
        String serialized = serializer.serialize(events);
    ...
    public void testMapOfObject() throws Exception {
        ...
        ObjectSerializer<Map<String, Event>> serializer = new MoshiObjectSerializer<Map<String, Event>>(Types.newParameterizedType(Map.class, String.class, Event.class));
        String serialized = serializer.serialize(eventMap);
