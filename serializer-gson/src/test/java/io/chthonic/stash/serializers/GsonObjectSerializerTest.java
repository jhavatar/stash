...
public class GsonObjectSerializerTest {
    ...
    public void testSimpleObject() throws Exception {
        ...
        ObjectSerializer<Event> serializer = new GsonObjectSerializer<Event>(Event.class);
    ...
    public void testObjectWithCollections() throws Exception {
        ...
        ObjectSerializer<CollecObj> serializer = new GsonObjectSerializer<CollecObj>(CollecObj.class);
    ...
    public void testListOfObject() throws Exception {
        ...
        ObjectSerializer<List<Event>> serializer = new GsonObjectSerializer<List<Event>>(listType);
    ...
    public void testMapOfObject() throws Exception {
        ...
        Type mapType = new TypeToken<HashMap<String, Event>>() {}.getType();
        ObjectSerializer<Map<String, Event>> serializer = new GsonObjectSerializer<Map<String, Event>>(mapType);
